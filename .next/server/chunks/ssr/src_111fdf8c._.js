...
function Hero({ holdings }) {
    ...
    const totalCost = holdings.reduce((sum, h)=>sum + (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calcHoldingCost"])(h), 0);
    const totalPnL = holdings.reduce((sum, h)=>sum + (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calcHoldingPnL"])(h), 0);
    const totalPnLPct = totalCost === 0 ? 0 : totalPnL / totalCost * 100;
    const dayChange = holdings.reduce((sum, h)=>sum + (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["calcDayChange"])(h), 0);
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        className: `badge ${dayUp ? 'badge-gain' : 'badge-loss'}`,
                        style: {
                            fontSize: 'var(--text-sm)',
                            padding: '5px 10px'
                        },
                    ...
                    children: [
                        {
                            ...
                            sub: `${isUp ? '+' : ''}$${Math.abs(totalPnL).toLocaleString('en-US', {
                        ...
                        {
                            label: "Today's P&L",
                            value: `${dayUp ? '+' : ''}$${Math.abs(dayChange).toLocaleString('en-US', {
                                maximumFractionDigits: 0
                            })}`,
...
//# sourceMappingURL=src_111fdf8c._.js.map